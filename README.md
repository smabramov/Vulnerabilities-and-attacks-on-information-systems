# «Уязвимости и атаки на информационные системы»- Абрамов Сергей
...
<br>
<details>
  <summary>Результат сканирования ВМ с Metasploitable</summary>

```shell
Starting Nmap 7.93 ( https://nmap.org ) at 2023-03-12 08:33 EDT
...
|   100005  1,2,3      42875/udp   mountd
|   100005  1,2,3      54536/tcp   mountd
|   100021  1,3,4      37983/tcp   nlockmgr
|   100021  1,3,4      46923/udp   nlockmgr
|   100024  1          36718/tcp   status
|_  100024  1          46907/udp   status
